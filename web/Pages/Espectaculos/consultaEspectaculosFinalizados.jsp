...
<%@page import="DTOs.EspecFinalizadoDTO"%>
        ...
        <div class="container" style="">
            <div class="row">
                <div class="col-12 d-flex justify-content-md-center">
                    <h1 class="mb-3">ESPECTÁCULOS FINALIZADOS</h1>
                </div>
            </div>
            <%
                if((ConsultaEspectaculoDTO) request.getAttribute("espec") == null){
                        List<EspecFinalizadoDTO> especs = (List<EspecFinalizadoDTO>)request.getAttribute("especsFinalizados");
                        if(especs.isEmpty()){
                            %>
                                <div class="d-flex justify-content-md-center align-items-center">
                                    <div>
                                        <h1>No tienes espectáculos finalizados</h1>
                                    </div>
                                </div>
                            <%
                        }else{
                     ...
                     <table id="tablaEspec" class="table table-bordered">
                        ...
                        <tbody id="myTable">
                            <%
                                ...
                                for (EspecFinalizadoDTO espec : especs) {
                            ...
                            <tr class="align-middle clickable-row">
                                <td id="nombreE" class="nombre"><%=espec.getNombre()%></td>
                                    ...
                                    <td>
                                        <div class="">
                                            <img style="max-height:55%; max-width:55%;object-fit: contain;" src="<%=espec.getImagen()%>">
                                        </div>
                                    </td>
                                </tr>
                            <%
