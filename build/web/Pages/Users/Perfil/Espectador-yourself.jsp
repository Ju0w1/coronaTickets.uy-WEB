...
<head>
  ...
  <title>ESPECTADOR-YOURSELF</title>
                  ...
                  <div class="func">
                    ...
                    <ul class="list-group list-group-flush">
                      <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                        <!-- NOMBRE -->
                        <h6 class="mb-0"> Nombre</h6>
                        <span class="text-secondary">Finde FREE</span>
                      </li>
                      <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                        <!-- ESPECTACULOS -->
                        <h6 class="mb-0"> Espectaculos</h6>
                        <span class="text-secondary">Carnaval, Gira de Rock, Las ...</span>
                      </li>
                      <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                        <!-- DESCUENTO -->
                        <h6 class="mb-0">
